          ...
          <div className="mx-3 md:mx-4 mb-3">
            <div className="flex items-center justify-between bg-amber-50 border border-amber-200 rounded-lg px-3 py-2">
              <span className="text-xs text-amber-800">
                <strong>Cotizador en construcción</strong> — Para una respuesta inmediata:
              </span>
              <a
                href="https://wa.me/541121596100?text=Hola!%20Quiero%20cotizar%20mi%20vehículo"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 bg-[#25D366] hover:bg-[#20BA5A] text-white font-medium px-3 py-1 rounded-md transition-colors text-xs shrink-0 ml-3">
