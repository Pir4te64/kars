...
import DollarBlueInfo from "@/components/DollarBlueInfo";
            ...
            <div className="mb-8 text-center">
              ...
              {dollarError && (
                <div className="mb-4 text-sm text-red-500">
                  Error al cargar cotización del dólar: {dollarError}
                </div>
              )}
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                {/* <button
                  ...
                  className="w-full bg-white text-blue-600 border border-blue-600 py-3 px-4 sm:px-6 rounded-lg flex items-center justify-center hover:bg-blue-50 transition-colors text-sm sm:text-base">
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5 mr-2 sm:mr-3 flex-shrink-0"
                    fill="none"
                    stroke="currentColor"
