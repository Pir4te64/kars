    ...
    <section className="relative w-full h-[calc(100vh-4rem)] sm:h-[calc(100vh-5rem)] md:h-[calc(100vh-6rem)] flex items-start justify-center bg-gradient-to-br from-slate-200 via-slate-300 to-slate-200 overflow-hidden z-0 pt-0 pb-0">
      ...
      `}>
        ...
        <div className="grid lg:grid-cols-2 h-full">
          ...
          <div className="relative ml-16 z-10 flex flex-col justify-start items-center lg:items-start p-4 sm:p-6 md:p-12 pt-8 sm:pt-12 md:pt-16 lg:pt-24 h-full">
            {/* Contenedor con ancho consistente para alinear todos los elementos */}
            <div className="w-full max-w-lg mx-auto lg:mx-0 lg:ml-auto lg:mr-12 space-y-2 sm:space-y-3 md:space-y-4 text-center lg:text-left">
              {/* Título Principal */}
              <h1
                className={`
                text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black leading-tight text-slate-900
              ...
              <p
                className={`
                text-sm sm:text-base md:text-lg text-slate-700 leading-relaxed mb-2 sm:mb-3
              ...
              `}>
                <button
                  onClick={() => {
                    const autosSection =
                      document.getElementById("autos-disponibles");
                    if (autosSection) {
          ...
          <div className="relative hidden lg:flex items-start justify-start lg:pl-0 overflow-hidden pt-2 sm:pt-6 md:pt-24 md:-mt-[15%]">
            ...
            `}>
              <Image
                ...
                alt="Vehículo Kars "
                fill
                className="object-contain object-left-top scale-100 md:scale-75"
                priority
        ...
        <div className="absolute bottom-20 sm:bottom-24 md:bottom-28 lg:bottom-8 left-0 right-0 px-4 z-30">
          <CarQuoteSection />
        </div>

        {/* Auto en mobile - debajo del cotizador */}
        <div className="lg:hidden absolute bottom-0 left-0 right-0 h-32 sm:h-36 md:h-40 flex items-center justify-center z-20 px-4">
          <div
            className={`
