...
const VendeTuAuto = () => {
  ...
  const handleOnSubmit = async () => {
    handleInputChange(
      "precio",
      years.filter((item) => item.year == formData.año)[0].price
    );
    console.log(years.filter((item) => item.year == formData.año)[0].price);
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-gray-900">
                    {brands.filter(item => item.id == formData.marca)[0].name}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Modelo:</span>
                  <span className="font-bold text-gray-900">
                    {models.filter(item => item.codia == formData.modelo)[0].description}
                  </span>
                </div>
              </div>
              <div className="space-y-3">
