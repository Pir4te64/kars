...
const CarDetail = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen text-xl bg-gray-50">
        Cargando...
      </div>
    );
  }
  if (error || !carData) {
    return (
      <div className="flex items-center justify-center min-h-screen text-xl text-red-500 bg-gray-50">
  ...
  const car = {
    ...
    seller: {
      ...
      title: carData.vendedor_titulo || "Asesor Certificado",
        ...
        <div className="grid gap-8 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mb-4 space-y-2">
              {/* Prepare WhatsApp link: use seller phone if available in carData, otherwise fallback to static number */}
              {(() => {
                // Attempt to read phone fields from carData safely
                const sellerPhoneRaw =
                  carData?.vendedor_telefono ||
                  carData?.vendedor_phone ||
                  carData?.telefono ||
            ...
            {cars
              ...
              .map((post) => (
                <div
                  ...
                  <div className="relative mb-4">
                    <div className="flex items-center justify-center w-full h-48 bg-gray-100 rounded-xl">
