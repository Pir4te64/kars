...
const Hero = () => {
  ...
  useEffect(() => {
    // Dispara la animación del auto al montar
      ...
      <div className="container px-4 mx-auto max-w-7xl">
        <div className="grid items-center gap-10 md:gap-12 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center">
            <h1 className="font-[Poppins] font-bold tracking-tight text-left text-4xl leading-[1.1] sm:text-5xl md:text-6xl">
              <span className="block text-black">Dale un giro a tu</span>
              <span className="block text-blue-500">camino</span>
            </h1>

            <p className="mt-4 max-w-md text-left font-[Poppins] text-base md:text-lg text-black">
              Entrega tu carro usado y súbete hoy mismo al auto que siempre
              soñaste.
            </p>
            ...
            <div className="mt-6 md:hidden">
              <button
                ...
                className="w-full rounded-full px-6 py-4 text-lg font-semibold text-white shadow-lg transition-transform hover:-translate-y-0.5 focus:outline-none focus:ring-2 focus:ring-blue-500 bg-[#2664C4]">
          ...
          <div className="relative flex items-center justify-center">
            {/* Contenedor proporcional, sin medidas fijas */}
            <div className="relative w-full max-w-3xl md:max-w-4xl aspect-[16/10] md:aspect-[16/9]">
              ...
              <div className="absolute z-20 flex items-center gap-3 px-3 py-2 shadow left-2 top-2 rounded-xl bg-sky-100/100 md:left-3 md:top-4 md:px-4 md:py-3">
                ...
                <p className="whitespace-nowrap font-[Poppins] text-sm font-semibold leading-5 md:text-base">
              ...
              <div className="absolute z-20 items-center hidden gap-3 px-4 py-3 shadow bottom-3 right-2 rounded-xl bg-sky-100/80 md:flex">
                ...
                <p className="whitespace-nowrap font-[Poppins] text-base font-semibold leading-5">
