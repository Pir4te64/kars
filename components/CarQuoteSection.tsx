        ...
        <div
          ...
          <div className="mx-3 md:mx-4 mb-2">
            <p className="text-[10px] text-amber-700 text-center">
              ...
              <a href="https://wa.me/541121596100?text=Hola!%20Quiero%20cotizar%20mi%20vehículo" target="_blank" rel="noopener noreferrer" className="font-semibold text-green-600 hover:underline">
