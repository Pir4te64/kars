      ...
      <div className="w-full px-4 pt-24 pb-8 mx-auto max-w-7xl">
        ...
        <div
          ...
          <div>
            ...
            <div className="space-y-3">
              {/* Button 1 - Primary */}
              {/* <button className="flex items-center justify-center w-full px-6 py-3 text-white transition-colors bg-blue-600 rounded-lg hover:bg-blue-700">
              ...
              {/* Button 2 - Secondary */}
              <button className="flex items-center justify-center w-full px-6 py-3 text-white transition-colors bg-green-600 rounded-lg hover:bg-green-700">
                <svg
              ...
              {/* <button
                ...
                className="flex items-center justify-center w-full px-6 py-3 text-blue-600 transition-colors bg-white border border-blue-600 rounded-lg hover:bg-blue-50">
                <svg
                  className="w-5 h-5 mr-3"
                  fill="none"
                  stroke="currentColor"
              ...
              {/* Button 4 - Tertiary */}
              {/* <button className="flex items-center justify-center w-full px-6 py-3 text-blue-600 transition-colors bg-white border border-blue-600 rounded-lg hover:bg-blue-50">
                <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
