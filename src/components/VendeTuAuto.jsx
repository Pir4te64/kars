    ...
    <div className="max-w-2xl mx-auto">
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="bg-primary-600 px-6 py-4 flex items-center">
          ...
          <h1 className="text-xl font-bold text-white">Datos básicos del vehículo</h1>
        </div>
        ...
        <div className="p-8">
          ...
          <div className="mt-8">
            <button
              onClick={handleNext}
              disabled={!formData.marca || !formData.modelo || !formData.año}
      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => handleInputChange('estadoGeneral1', e.target.value)}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg appearance-none bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                >
                  <option value="">Seleccione</option>
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => handleInputChange('estadoGeneral2', e.target.value)}
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg appearance-none bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                >
                  <option value="">Seleccione</option>
                  ...
                  <option value="suspension-perfecta">Suspensión perfecta</option>
          ...
          <div className="mt-8 flex space-x-4">
            ...
            <button
              onClick={handleNext}
              disabled={!formData.kilometraje || !formData.transmision || !formData.combustible || !formData.estadoGeneral1 || !formData.estadoGeneral2}
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Con la placa podemos validar el historial del vehículo y ofrecerte una cotización más precisa.
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="p-8">
          ...
          <div className="mt-8">
            <button
              onClick={handleNext}
              disabled={!formData.nombre || !formData.telefono || !formData.email}
              className="w-full bg-primary-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-primary-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
            >
              Ver resultado
            </button>
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Resultado de tu cotización</h1>
      ...
      <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
        <div className="p-8">
          ...
          <div className="flex items-start mb-8">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900 mb-2">Este es el valor estimado de tu vehículo</h2>
              <p className="text-gray-500">Estimación basada en los datos proporcionados</p>
            </div>
          </div>

          {/* Vehicle Summary Section */}
          <div className="mb-8">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Auto ingresado (resumen):</h3>
            <div className="grid grid-cols-2 gap-8">
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">Marca:</span>
                  <span className="font-bold text-gray-900">{formData.marca}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Año:</span>
                  <span className="font-bold text-gray-900">{formData.año}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Kilometraje:</span>
                  <span className="font-bold text-gray-900">{formData.kilometraje} km</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Ciudad:</span>
                  <span className="font-bold text-gray-900">{formData.ciudad}</span>
                </div>
              </div>
              <div className="space-y-3">
                <div className="flex justify-between">
                  <span className="text-gray-600">Modelo:</span>
                  <span className="font-bold text-gray-900">{formData.modelo}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Versión:</span>
                  <span className="font-bold text-gray-900">{formData.transmision === 'automatica' ? 'Automático' : 'Manual'}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-gray-600">Estado:</span>
                  <span className="font-bold text-gray-900">{formData.estadoGeneral1}</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-8">
            <h3 className="text-lg font-bold text-gray-900 mb-4">Estimación:</h3>
            <div className="bg-blue-50 rounded-lg p-6 inline-block">
              <div className="text-3xl font-bold text-primary-600 mb-2">$45.000.000 - $48.500.000</div>
              <p className="text-sm text-gray-500">Nota: Este valor es una estimación inicial. El precio final se confirmará tras la inspección.</p>
            </div>
          </div>

          {/* Main CTAs Section */}
          <div>
            <h3 className="text-lg font-bold text-gray-900 mb-4">CTAs principales:</h3>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <button className="bg-white text-gray-700 py-3 px-4 rounded-lg border border-gray-300 hover:bg-gray-50 transition-colors flex items-center justify-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h19a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                  </svg>
                  Enviar por correo
                </button>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="p-8">
            ...
            <div className="flex items-center mb-6">
              ...
              <h2 className="text-xl font-bold text-gray-900">Enviar resumen a tu correo</h2>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                />
                <label htmlFor="email-estimate" className="ml-3 text-sm text-gray-700">
      ...
      {!showResults && (
        <div className="max-w-2xl mx-auto mb-8 px-4">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-2xl font-bold text-gray-900">Cotiza tu vehículo</h2>
            <span className="text-lg font-semibold text-primary-600">Paso {currentStep} de 4</span>
          </div>
